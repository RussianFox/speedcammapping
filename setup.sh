...
ln -s /git/speedcammapping/web /srv/www/htdocs/speedcammapping
...
ln -s /git/roadsituation/server/php-fpm/speedcammapping.conf /etc/php-fpm.d/speedcammapping.conf
